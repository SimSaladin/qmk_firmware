...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_80_with_macro(
    ...
    KC_BRIU, RGB_TOG, MO(2),   KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,  KC_PGUP,
    KC_BRID, KC_UP,   KC_LSFT,          KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, _______, KC_PGDN,
    KC_LEFT, KC_DOWN, KC_LCTL, KC_LGUI, KC_LALT, MO(1),   _______, KC_SPC,           KC_SPC,  MO(1),   KC_RALT, KC_RGUI, _______, KC_RCTL, MO(1),   KC_RGHT
  ),
  ...
  [2] = LAYOUT_80_with_macro( // mouse keys
